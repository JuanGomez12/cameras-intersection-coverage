...
//Assignment 1 process and pipes
    ...
    char* a1_argv[2];
    a1_argv[0] = (char*)"intersection-a1.py";
    a1_argv[1] = nullptr;
    if (verbose){
        std::cout << "[A3] executing './intersection-a1.py' using execv" << std::endl;
    }
    child_pid = fork ();
    if (child_pid == 0) {
        ...
        //Run A1
        execv ("./intersection-a1.py", a1_argv);
    ...
    char* a2_argv[2];
    a2_argv[0] = (char*)"intersection-a2";
    a2_argv[1] = nullptr;
    if (verbose){
        std::cout << "[A3] executing './intersection-a2' using execv" << std::endl;
    }
    
    execv ("./intersection-a2", a2_argv);
